...
export type FixedGame = {team: string; category?: string; result?: Outcome; probabilities?: Probabilities; decision?: 'advanced_on_penalties'|'eliminated_on_penalties'; completed?: boolean};
