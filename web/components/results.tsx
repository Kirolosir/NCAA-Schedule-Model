...
export function Results({report,selected,onSelect,stale,onEdit,onOpenScenario}:{
  ...
  const bestRecord={...locked,win:locked.win+openGames};
  const worstRecord={...locked,loss:locked.loss+openGames};
